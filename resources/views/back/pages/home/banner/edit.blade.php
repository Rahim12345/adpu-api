        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <a href="{{ route('home-banner.index') }}" class="link-primary">@lang('pages/home/banner.table_header')</a>
                    </h3>
                </div>
                <div class="card-body border-bottom py-3">
                    <form action="{{ route('home-banner.update',$homeBanner->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row mb-2 col-md-12">
                            <img src="{{ asset($homeBanner->src) }}" alt="{{ $homeBanner->alt }}" class="img-100px">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="alt" class="form-control" name="alt" placeholder="@lang('pages/home/banner.alt')" value="{{ old('alt',$homeBanner->alt) }}">
                                @error('alt')
                                <small class="text-danger mt-1">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="language_id" id="language_id" class="form-control @error('alt') is-invalid @enderror">
                                    ...
                                    @foreach($languages as $language)
                                        <option value="{{ $language->id }}" @selected(old('language_id', $homeBanner->language_id) == $language->id)>{{ $language->language }}</option>
                                    @endforeach
                                </select>
