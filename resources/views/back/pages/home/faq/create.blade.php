        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body border-bottom py-3">
                    <form action="{{ route('home-faq.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row mb-2 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" id="question" class="form-control @error('question') is-invalid @enderror" name="question" placeholder="Təqaüdlər nə zaman ödənilir ?" value="{{ old('question') }}">
                                @error('question')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="answer" id="answer" class="form-control @error('answer') is-invalid @enderror" placeholder="Hər ayın təqaüdü növbəti ayın 10-a qədər hesablara yüklənir. Yay aylarının təqaüdləri isə sentyabr-oktyabr aylarında ödənilir." cols="30" rows="4">{{ old('answer') }}</textarea>
                                @error('answer')
                                <small class="text-danger mt-1">{{ $message }}</small>
                                @enderror
                            </div>
