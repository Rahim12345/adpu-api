        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body border-bottom py-3">
                    <form action="{{ route('chronology.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row mb-2 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" id="date" class="form-control @error('date') is-invalid @enderror" name="date" placeholder="26 avqust 1921-ci il" value="{{ old('date') }}">
                                @error('date')
