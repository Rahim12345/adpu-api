        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body border-bottom py-3">
                    <form action="{{ route('home-special-program.update',$specialProgram->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row mb-2 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" id="program_name" class="form-control @error('program_name') is-invalid @enderror" name="program_name" placeholder="VAŞİNQTON UNİVERSİTETİNDƏ TƏHSİL İMKANI NƏDİR?" value="{{ old('program_name',$specialProgram->program_name) }}">
                                @error('program_name')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="program_description" id="program_description" class="form-control @error('program_description') is-invalid @enderror" cols="30" rows="4">{{ old('program_description',$specialProgram->program_description) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="language_id" id="language_id" class="form-control @error('alt') is-invalid @enderror">
                                    ...
                                    @foreach($languages as $language)
                                        <option value="{{ $language->id }}" @selected(old('language_id', $specialProgram->language_id) == $language->id)>{{ $language->language }}</option>
                                    @endforeach
                                </select>
