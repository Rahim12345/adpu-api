        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body border-bottom py-3">
                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="w-100" id="submitedForm">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" id="last_name" value="{{ old('last_name') }}" autocomplete="off">
                                @error('last_name')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" autocomplete="off">
                                @error('email')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
